...
class GeoIP(object):
    ...
    def init_app(self, app):
        """A IP to city, country, and ASN lookup.
        ...
        :param city_database: A filepath to geo_city database
        :type city_database: [type]
        :param country_database: [description]
        :type country_database: [type]
        :param asn_database: [description]
        :type asn_database: [type]
        """
        ...
        self._geo_country = database.Reader(app.config.get('MAXMIND_COUNTRY_PATH'))
